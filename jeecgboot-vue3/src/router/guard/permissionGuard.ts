...
const PcSetFileListRoute = PageEnum.PcSetFileListRoute;
...
const whitePathList: PageEnum[] = [LOGIN_PATH, OAUTH2_LOGIN_PAGE_PATH,SYS_FILES_PATH, TOKEN_LOGIN,PcSetFileListRoute ];
